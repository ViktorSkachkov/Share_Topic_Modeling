...
model_file = os.path.join(data_folder, 'fastopic_model18.pkl')
...
try:
    from FASTopic_Modeling import topic_modeling_initializer
...
topic_modeling_initializer(input_file, output_file, output_subfolder, stop_words_english, stop_words_dutch, stop_words_custom, model_file, epochs, num_top_words, num_topics)
